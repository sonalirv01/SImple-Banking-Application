...
public class AccountService {
    ...
    public Account createAccount(String name, int pin){
        // Initialize a new Account object with 'name' and 'pin'
        Account newAccount = new Account(name, pin);

        // Add it to the 'accounts' list
        accounts.add(newAccount);

        // Print success message with the account number
    ...
    public void deposit(Account account, double amount){
        ...
        // Set the balance to current balance + deposited amount
    ...
    public void transfer(Account senderAccount, Account recipientAccount, double amount){
        ...
        // Increment the recipient's account balance
